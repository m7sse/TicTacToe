...
class TicTacToeModelTest {
    ...
    @BeforeEach
    void setUp() {
        model = new TicTacToeModel(); // skapa en ny modell innan varje test
    }

    @Test
    void isValidMove() {
        // testar giltiga och ogiltiga drag
        assertTrue(model.isValidMove(0, 0), "Move at (0,0) should be valid on an empty board");
        model.makeMove(0, 0); // gör ett drag
    ...
    @Test
    void makeMove() {
        // testar att göra drag, vilka som går, går ej, osv
